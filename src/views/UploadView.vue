<template>
  <div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
      ...
      <!-- Компонент для управления известными кошельками -->
      <KnownWalletsManager />
      ...
      <div class="mt-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
        ...
        <div class="prose dark:prose-invert max-w-none">
          ...
          <ul>
            ...
            <li>Save known wallets to automatically exclude them from analysis</li>
          </ul>
...
import KnownWalletsManager from '@/components/KnownWalletsManager.vue';
...
export default {
  ...
  setup() {
    ...
    // Инициализируем базу известных кошельков при загрузке страницы
    onMounted(async () => {
      if (!knownWalletsStore.dbReady) {
        try {
          await knownWalletsStore.initDatabase();
        } catch (error) {
          console.error('Ошибка при инициализации базы данных известных кошельков:', error);
        }
      }
    });
